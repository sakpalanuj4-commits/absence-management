...
TEMPLATES = [
    ...
    {
        # The Django admin and the built-in auth views need this backend.
...
SESSION_COOKIE_AGE = int(env("SESSION_TIMEOUT_MINUTES", "60")) * 60
...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", "no-reply@absence-management.local")
